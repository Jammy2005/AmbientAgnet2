...
default_background = """ 
I'm Ahmad, i make agentic applications for DPS.
"""
...
2. schedule_meeting_tool(attendees, subject, duration_minutes, preferred_day, start_time)
   - Schedule a calendar meeting.
     • preferred_day: a datetime object (date-only is fine; time part is ignored)
     • start_time: **int hour 0-23 (e.g. 9 for 09:00, 14 for 14:00). Do NOT pass 930 or HHMM formats.**

3. calendar_freebusy(day)
   - Return busy slots for the specified day (YYYY-MM-DD or datetime).

4. Question(content)
   - Ask the user a follow-up question and wait for their response.
